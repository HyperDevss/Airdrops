...
final class SimpleInvMenuTransaction implements InvMenuTransaction{
	...
	#[Pure] public function getItemClicked() : Item{
		return $this->getOut();
	}

	#[Pure] public function getItemClickedWith() : Item{
		return $this->getIn();
	}
	...
	#[Pure] public function continue() : InvMenuTransactionResult{
		return new InvMenuTransactionResult(false);
	}

	#[Pure] public function discard() : InvMenuTransactionResult{
